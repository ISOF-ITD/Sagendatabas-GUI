...
export default class TopicNetworkGraph extends React.Component {
	constructor(props) {
		super(props);
		...
		this.graphNodeDragStarted = this.graphNodeDragStarted.bind(this);
		this.graphNodeDragged = this.graphNodeDragged.bind(this);
		this.graphNodeDragEnded = this.graphNodeDragEnded.bind(this);
	...
	fetchData(params) {
		...
		fetch(config.apiUrl+config.endpoints.topics_graph+'?'+paramString)
	...
	renderGraph() {
		...
		var node = graph.append('g')
			...
			.call(d3.drag()
				.on('start', this.graphNodeDragStarted.bind(this))
				.on('drag', this.graphNodeDragged.bind(this))
				.on('end', this.graphNodeDragEnded.bind(this)));
