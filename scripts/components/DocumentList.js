				...
				<div className={'documents-list'+(this.state.loading ? ' loading' : '')+(this.props.disableContainerStyle ? ' container-style-disabled' : '')}>
					{
						...
						<div className="list-heading">
							<DropdownMenu label={'Sortering: '+l(this.state.sort)+', '+l(this.state.sortOrder)}>
								...
								<div className="sort-item"><strong>{l('Kategori')}</strong>: <a onClick={this.orderLinkClickHandler} data-sort="taxonomy.category" data-order="asc">{l('asc')}</a>, <a onClick={this.orderLinkClickHandler} data-sort="taxonomy.category" data-order="desc">{l('desc')}</a></div>
							</DropdownMenu>
